...
// ProcessDumpSpec defines the desired state of ProcessDump
type ProcessDumpSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of ProcessDump. Edit processdump_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// ProcessDumpStatus defines the observed state of ProcessDump
